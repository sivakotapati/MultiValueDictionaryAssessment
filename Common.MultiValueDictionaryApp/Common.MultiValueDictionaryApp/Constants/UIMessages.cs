...
namespace Common.MultiValueDictionaryApp.Constants
{
    public class UIMessages
    {
        ...
        public const string InvalidOperation = "Invalid operation. Please enter valid operation.";
        public const string InvalidInput = "Invalid input.";
        public const string KeyNotExists = "key does not exist";
        public const string MemberAlreadyExists = "Member already exists for key";
        public const string MemberNotExists = "Member does not exists for key";
